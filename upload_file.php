          ...
          <div class="row">
			...
			<?php
					if (isset($_POST['submit']))
					{
						...
						//initialze default scan error variable
						$scanError = "no";
						...
						if ($file['error'] === UPLOAD_ERR_OK) {
							...
							if ($scanResult['response_code'] == 1) {
								...
								//if file to large, display alert message, scanning, uploading and file encryption will not  continue
								$scanError = "yes";
						...
						//jika scan/upload fail, display alert
						if($scanError == "yes")
						{
							echo "<div class='alert alert-danger alert-dismissible'>
									<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
									<strong>Sorry!</strong> Failed to scan file. 
								</div>";
						}
						//sebaliknya,, proceed dgn upload dan encrypt
						else
						{
